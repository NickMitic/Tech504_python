...
want_rating = "Y"
while want_rating == "Y" or want_rating == "y":
    film_rating = ""
    while film_rating not in ratings:
        print("Possible film ratings are universal, pg, 12, 12a, 15 and 18")
        film_rating = input("Please enter the film rating ")
...
# check if film rating is "18"
    ...
    want_rating = input("Would you like to check another movie rating? Y/N? ")